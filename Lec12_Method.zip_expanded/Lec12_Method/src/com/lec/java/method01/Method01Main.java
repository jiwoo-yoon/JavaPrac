...
public class Method01Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("제 이름은 김기자 입니다.");
		
		System.out.println("안녕하세요");
		System.out.println("제 이름은 박은수 입니다.");
		
		System.out.println("안녕하세요");
		System.out.println("제 이름은 조은아 입니다.");
		
		System.out.println();
		// 메소드 사용 : 메소드 호출(method call, invoke)
		sayHello("정예경");  
		sayHello("김진후");
	...
	// 메소드 위에 아래와 같이 JavaDoc 타입의 주석을 달수 있다.
	...
	public static void sayHello(String name) {
		...
		// 메소드가 종료되면 메소드를 호출한쪽으로 돌아온다 (리턴 return 한다)
	} // end sayHello(String)
